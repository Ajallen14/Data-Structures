...
##### [**PRIORITY QUEUE** using **linked list** concept](https://github.com/Ajallen14/Data-Structures/blob/master/Queue/Priority%20queue/priority_queue.c)
##### [**PRIORITY QUEUE** using **array** concept](https://github.com/Ajallen14/Data-Structures/blob/master/Queue/Priority%20queue/priority_queue%20(array).c)
...
##### [**DEQUE using linked list concept**](https://github.com/Ajallen14/Data-Structures/blob/master/Queue/Deque/Deque.c)
##### [**DEQUE using array concept**](https://github.com/Ajallen14/Data-Structures/blob/master/Queue/Deque/Deque%20(array).c)
...
### [using Linked list](https://github.com/Ajallen14/Data-Structures/blob/master/Tree/binary_tree(LL).c)

### [using Array](https://github.com/Ajallen14/Data-Structures/blob/master/Tree/binary_tree(Array).c)
